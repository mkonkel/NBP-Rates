...
class CurrencyDetailsApiIntegrationTest : KoinTest {
    ...
    @Test
    fun `getCurrencyRatesLastDays should make real API call and return serialized data`() = runTest {
    ...
    @Test
    fun `getCurrencyRatesLastDays should properly serialize all currency fields`() = runTest {
        // Given - API instance injected by Koin
        val code = "EUR"
        val days = 3
